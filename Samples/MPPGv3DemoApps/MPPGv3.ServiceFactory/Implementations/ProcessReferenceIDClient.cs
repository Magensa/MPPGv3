...
{
    public class ProcessReferenceIDClient : IProcessReferenceIDClient
    {
        private IConfiguration _config;
        public Uri Host { get; private set; }
        public ProcessReferenceIDClient(IConfiguration config)
        {
            _config = config;
        ...
        public (ProcessReferenceIDResponseDto Response, RawSoapDetails SoapDetails) ProcessReferenceID(ProcessReferenceIDRequestDto dto)
        {
            ...
            try
            {
                var requests = new List<ProcessReferenceIDRequest>();
                var request = new ProcessReferenceIDRequest
                {
                    ...
                    TransactionInput = new ReferenceIDTransactionInput
                    {
                        Amount = dto.Amount,
                        ...
                        ReferenceAuthCode = dto.ReferenceAuthCode,
                ...
                var svcResponse = svcClient.ProcessReferenceIDAsync(requests.ToArray()).Result;
                ...
                {
                    result.Response = new ProcessReferenceIDResponseDto
                    {
